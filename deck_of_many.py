...
{'card': 'King of hearts', 'name': 'Throne',},
{'card': 'Queen of hearts', 'name': 'Key', 'desc': "A rare or rarer Magic Weapon with which you are proficient appears in your hands. The DM chooses the weapon."},
{'card': 'Jack of hearts', 'name': 'Knight', 'desc': "You gain the service of a 4th-level Fighter who appears in a space you choose within 30 feet of you. The Fighter is of the same race as you and serves you loyally until death, believing the fates have drawn him or her to you. You control this character."},
{'card': 'King of clubs', 'name': 'Void',},
{'card': 'Queen of clubs', 'name': 'Flames', 'desc': "A powerful devil becomes your enemy. The devil seeks your ruin and plagues your life, savoring your suffering before attempting to slay you. This enmity lasts until either you or the devil dies."},
{'card': 'Jack of clubs', 'name': 'Skull',},
{'card': 'King of spades', 'name': 'Ruin',},
{'card': 'Queen of spades', 'name': 'Euryale', 'desc': "The card's medusa-like visage curses you. You take a -2 penalty on Saving Throws while Cursed in this way. Only a god or the magic of The Fates card can end this curse."},
{'card': 'Jack of spades', 'name': 'Rogue',},
